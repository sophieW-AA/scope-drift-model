"""Create or update the Data Mapping page under Scope Drift."""
...
BODY_FILE = ROOT / "docs" / "confluence-data-mapping.storage.html"
SPACE_KEY = "DA"
PARENT_ID = "725460028"
TITLE = "Data Mapping"
...
def main() -> None:
    ...
    if existing:
        ...
        payload["version"] = {
            ...
            "message": "BigQuery data dictionary refresh",
        }
