"""Create or update the Citation Network page under Scope Drift."""
...
BODY_FILE = ROOT / "docs" / "confluence-citation-network.storage.html"
SPACE_KEY = "DA"
PARENT_ID = "725460028"
...
def main() -> None:
    ...
    if existing:
        ...
        payload["version"] = {
            ...
            "message": "Citation network method documentation",
        }
