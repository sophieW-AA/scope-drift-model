...
def main() -> None:
    ...
    if df["has_section"].any():
        ...
        by_sec.to_csv(WORK_DIR / "neurorobotics_oos_by_section_taxonomy.csv", index=False)
    ...
    out = WORK_DIR / "neurorobotics_taxonomy_join.parquet"
    ...
    (WORK_DIR / "neurorobotics_taxonomy_summary.json").write_text(json.dumps(summary, indent=2), encoding="utf-8")
