...
JOURNAL_IDS_OVERRIDE = os.environ.get("JOURNAL_IDS", "1675037245440,1589137899520,2336462209024,2774548873217,120259084288,764504178688,1005022347264,558345748481").strip()
